...
@Input() navState = false;
  ...
  ngOnInit(): void {
    this.currentMenus=[
      ...
      {"menuName":"Purchase Request","url":"#","icon":"work_outline","designation":"MANAGER"},
      ...
      {"menuName":"Delivery","url":"#","icon":"work_outline","designation":"MANAGER"},
      ...
      {"menuName":"Supplier Management","url":"#","icon":"work_outline","designation":"MANAGER"},
