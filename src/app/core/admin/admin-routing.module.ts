...
const routes:Routes =[
  ...
  path: '', component: AdminComponent, children:[
      ...
      { path: 'payment', loadChildren: () => import('../../modules/admin/customer-payments/customer-payments.module').then(m => m.CustomerPaymentsModule),canActivateChild: [AdminAuthGuard],data: { expectedSubRole: 'MANAGER' }  },
